...
void shadows_SetPreferences(int (*getint)())
{
...
void shadows_ComputeColor(unsigned short br, unsigned short bg, unsigned short bb, unsigned short *rr, unsigned short *rg, unsigned short *rb, int color)
{
    unsigned long lum;
