 ...
 */
u_int TIFFComputeTile(TIFF *tif, u_long x, u_long y, u_int s, u_long z)
{
 ...
 */
u_int TIFFNumberOfTiles(TIFF *tif)
{
	TIFFDirectory *td = &tif->tif_dir;
	u_long dx = td->td_tilewidth;
	u_long dy = td->td_tilelength;
 ...
 */
u_long TIFFTileRowSize(TIFF *tif)
{
	TIFFDirectory *td = &tif->tif_dir;
	u_long rowsize;
 ...
 */
u_long TIFFVTileSize(TIFF *tif, u_long nrows)
{
	TIFFDirectory *td = &tif->tif_dir;
	u_long tilesize;
