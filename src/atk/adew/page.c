...
boolean page__AddObject(struct page *self, struct dataobject *d, char *label, char *viewname, long which)
{
...
char * page__GetSwitcheeName(struct page *self, struct page_switchee *sw)
{
...
char * page__GetNowPlayingName(struct page *self)
{
    struct page_switchee *sw;
