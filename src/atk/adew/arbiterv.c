...
void arbiterview__SetDataObject(struct arbiterview *self, struct dataobject *dd)
{
    arbiter_SetApplication((struct arbiter *)dd,cel_APPLICATION);
...
void arbiterview__LinkTree(struct arbiterview *self, struct view *parent)
{
