...
enum view_DSattributes bpv__DesiredSize(struct bpv *self, long width, long height, enum view_DSpass pass, long *desiredwidth, long *desiredheight)
{
    *desiredwidth = width;
    *desiredheight = 6;
    return(view_HeightFlexible | view_WidthFlexible);
}
void bpv__FullUpdate(struct bpv *self, enum view_UpdateType type, long left, long top, long width, long height)
{
...
void bpv__Print(struct bpv *self, FILE *f, char *process, char *final, boolean toplevel)
{
	fputs(".OC\n.bp\n",f);
    }
