...
long textview__LineRedraw(struct textview *self, enum textview_LineRedrawType type, struct mark *currentLine, long x, long y, long xSize, long ySize, long search, boolean *cont, long *txheight, struct formattinginfo *info)
{
