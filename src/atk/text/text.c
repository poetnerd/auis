...
static struct environment *text__AlwaysWrapViewChar(struct text *self, long pos, char *viewtype, struct dataobject *dataobject)
{
...
static void text__WriteSubString(struct text *self, long pos, long len, FILE *file, int quoteCharacters)
{
    struct environment *rootenv;
    struct environment *startenv;
    struct environment *endenv;
...
static struct environment *text__EnumerateEnvironments(struct text *self, long pos, long len, boolean (*callBack)(), long rock)
