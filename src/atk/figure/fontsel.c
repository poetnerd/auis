...
boolean fontsel__InitializeObject(struct classheader *ClassID, struct fontsel *self)
{
...
void fontsel__FinalizeObject(struct classheader *ClassID, struct fontsel *self)
{
    free(self->family);
}
