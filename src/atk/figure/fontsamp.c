...
boolean fontsample__InitializeClass(struct classheader *ClassID)
{
    return TRUE;
}

boolean fontsample__InitializeObject(struct classheader *ClassID, struct fontsample *self)
{
...
void fontsample__FinalizeObject(struct classheader *ClassID, struct fontsample *self)
{
...
void fontsample__ObservedChanged(struct fontsample *self, struct observable *dobj, long status)
{
