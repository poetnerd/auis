...
enum view_DSattributes dialogv__DesiredSize(struct dialogv *self, long width, long height, enum view_DSpass pass, long *dWidth, long *dHeight)
{
    long iw, ih;
    long dummy;
    long oldheight;
...
int dialogv__PostInput(struct dialogv *dv, struct im *im, struct view *client, procedure choicefunc, void *choicerock, boolean block, long pos)
{
    struct im *new;
    struct sbutton *sb=dialogv_GetButtonsData(dv);
    procedure oldconfigfunc;
