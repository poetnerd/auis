...
static void ChangeStyle(struct lookzview *self)
{
...
static void RulerValueChanged(struct lprrulerview *rv, struct lookzview *self, enum iconcode icon, long newvalue)
{
...
static void TabsValueChanged(struct lprrulerview *rv, struct lookzview *self, long pos, enum style_TabAlignment op, enum style_Unit unit)
{
	if (self->curstyle == NULL) return;
...
*/
static void SetBitsForCode(unsigned long code, struct strTbl names[], struct stringtbl *tbl, long parity)
{
	long i;
	short accnum;
...
*/
static void SetStyleDisplay(struct lookzview *self, struct style *st)
{
	self->curstyle = st;
	if (st) 
		UnpackStyle(self);
...
static void ClearStyleDisplay(struct lookzview *self)
{
	long i;
...
*/
static void CloseStyleSheet(struct lookzview *self)
{
...
static boolean AddCardName(struct style *s, struct stringtbl *st)
{
...
static void OpenStyleSheet(struct lookzview *self, struct stylesheet *ss)
{
	self->curss = ss;
	if (ss != NULL) {
...
static boolean FindAndUnpack(struct style *s, struct lookzview *lv)
{
...
static boolean FindAndUnpackNoMenus(struct style *s, struct lookzview *lv)
{
	register char *mnnm = style_GetMenuName(s);
	if (mnnm == NULL) {
...
static void HitStyleName(struct stringtbl *st1, struct lookzview *lv, long accnum)
{
...
static void HitStyleNameNoMenus(struct stringtbl *st1, struct lookzview *lv, long accnum)
{
	strtblview_OneOnly(st1, lv, accnum);
	ClearStyleDisplay(lv);
	TempStyleName = (char *) 
...
static boolean AddStyleName(struct style *s, struct lookzview *lv)
{
...
static boolean AddStyleNameNoMenus(struct style *s, struct lookzview *lv)
{
	register char *mnnm = style_GetMenuName(s), *ThisStylename;
	if (mnnm == NULL) {
...
static void HitMenuCard(struct stringtbl *st0, struct lookzview *lv, long accnum)
{
...
static char * GetStringValue(struct stringtbl *st, struct lookzview *self, short accnum, char *prompt)
{
	char *str;
...
static void HitFont(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
...
static void HitSize(struct stringtbl *st, struct lookzview *self, long accnum)
{
	enum style_FontSize basis;
	long points;
	if (self->curstyle == NULL) return;
...
static void HitMode(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
	strtblview_ZeroOrOne(st, self, accnum);
	if (stringtbl_GetBitOfEntry(st, accnum)) {
...
static void HitSubscr(struct stringtbl *st, struct lookzview *self, long accnum)
{
...
*/
static void FinagleStyleBits(struct lookzview *self, struct stringtbl *st, long accnum, long parity, unsigned long *faces, unsigned long *flags)
{
	char *str;
	unsigned long bit;
	unsigned long *which;
...
static void HitEnable(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
...
static void HitDisable(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
	strtblview_ZeroOrMany(st, self, accnum);
...
static void HitSpacing(struct stringtbl *st, struct lookzview *self, long accnum)
{
	enum style_SpacingValue basis;
	long points;
	if (self->curstyle == NULL) return;
...
static void HitSpread(struct stringtbl *st, struct lookzview *self, long accnum)
{
	enum style_SpacingValue basis;
	long points;
	if (self->curstyle == NULL) return;
...
static void HitColor(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
	strtblview_ZeroOrOne(st, self, accnum);
	if (stringtbl_GetBitOfEntry(st, accnum))  {
...
static void HitShrink(struct labelview *shrink, enum view_MouseAction action, struct lookzview *self)
{
	struct lookz *lookz;
...
void ChooseShrinkIcon(struct lookzview *self)
{
...
static struct lpair * LL(enum dir dir, long pct, struct lpair *top, struct lpair *bot)
{
...
static struct lpair * LBL(char *label, struct view *view)
{
...
static void EditStylesInWindow(struct view *textv)
{
...
static void NewTextObject(struct lookzview *self, struct text *text)
{
	CloseStyleSheet(self);
	if (text != NULL) 
...
static void BuildImage(struct lookzview *self)
{
	struct lpair *R[7];
...
boolean lookzview__InitializeClass(struct classheader *ClassID)
{
	struct classinfo *textviewClassinfo;

	textviewClassinfo = class_Load("textview");
	proctable_DefineProc("lookzview-edit-styles", (procedure) EditStylesInWindow,
...
boolean lookzview__InitializeObject(struct classheader *ClassID, struct lookzview *self)
{
	long i, j;
...
ENTER(lookzview__InitializeObject);
	...
	labelview_SetHitProc(self->shrinkicon, HitShrink,
			(char *) self);
...
void lookzview__FinalizeObject(struct classheader *ClassID, struct lookzview *self)
{
...
struct lookzview * lookzview__GetApplicationLayer(struct lookzview *self)
{
	self->embedded = FALSE;
...
void lookzview__LinkTree(struct lookzview *self, struct view *parent)
{
...
void lookzview__WantInputFocus(struct lookzview *self, struct view *child)
{
...
void lookzview__ReceiveInputFocus(struct lookzview *self)
{
...
void lookzview__LoseInputFocus(struct lookzview *self)
{
...
void lookzview__FullUpdate(struct lookzview *self, enum view_UpdateType type, long left, long top, long width, long height)
{
	struct rectangle r;
	int i;
...
void lookzview__Update(struct lookzview *self)
{
...
struct view * lookzview__Hit(struct lookzview *self, enum view_MouseAction action, long x, long y, long num_clicks)
{
	struct view *ret;
...
void lookzview__Print(struct lookzview *self, FILE *file, char *processor, char *format, boolean level)
{
	/* never print anything */
}

void lookzview__ObservedChanged(struct lookzview *self, struct observable *dobj, long status)
{
...
void lookzview__SetVisibility(struct lookzview *self, boolean visibility)
{
...
boolean lookzview__GetVisibility(struct lookzview *self)
{
	return lookz_GetVisibility(lookzview_GetDataObject(self));
}

void lookzview__SetStyleSheet(struct lookzview *self, struct stylesheet *ss)
{
	CloseStyleSheet(self);
	OpenStyleSheet(self, ss);
}

struct stylesheet * lookzview__GetStyleSheet(struct lookzview *self)
{
	return self->curss;
}

void lookzview__SetEmbedded(struct lookzview *self, boolean isEmbedded)
{
	self->embedded = isEmbedded;
}

static void UpdateDocument(struct lookzview *self)
{
	struct lookz *lookz;
	struct text *text;
...
*/
static boolean FindCardName(struct style *s, char *nm)
{
	register char *mnnm = style_GetMenuName(s);
	register char *iw;
...
*/
static char * NewMenuName(struct lookzview *lv, char *name)
{
	static char buf[100];
	char *tilde, *comma;
	char *eltloc;
...
static void AddStyle(struct lookzview *self)
{
...
static void DeleteStyle(struct lookzview *self)
{
	struct style *delsty;
	struct lookz *lz;
	struct text *txt;
...
void lookzview__SetDataObject(struct lookzview *self, struct dataobject *dobj)
{
