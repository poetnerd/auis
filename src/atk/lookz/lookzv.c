...
*/
static MapStringToDelta(char *str, long *dots, enum style_FontSize *basis)
{
...
*/
static SetBitsForCode(unsigned long code, struct strTbl names[], struct stringtbl *tbl, long parity)
{
	long i;
	short accnum;
...
static OpenStyleSheet(struct lookzview *self, struct stylesheet *ss)
{
	self->curss = ss;
	if (ss != NULL) {
...
static HitStyleName(struct stringtbl *st1, struct lookzview *lv, long accnum)
{
...
static HitStyleNameNoMenus(struct stringtbl *st1, struct lookzview *lv, long accnum)
{
	strtblview_OneOnly(st1, lv, accnum);
	ClearStyleDisplay(lv);
	TempStyleName = (char *) 
...
static HitMenuCard(struct stringtbl *st0, struct lookzview *lv, long accnum)
{
...
static HitFont(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
...
static HitSize(struct stringtbl *st, struct lookzview *self, long accnum)
{
	enum style_FontSize basis;
	long points;
	if (self->curstyle == NULL) return;
...
static HitMode(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
	strtblview_ZeroOrOne(st, self, accnum);
	if (stringtbl_GetBitOfEntry(st, accnum)) {
...
static HitSubscr(struct stringtbl *st, struct lookzview *self, long accnum)
{
...
*/
static FinagleStyleBits(struct lookzview *self, struct stringtbl *st, long accnum, long parity, unsigned long *faces, unsigned long *flags)
{
	char *str;
	unsigned long bit;
	unsigned long *which;
...
static HitEnable(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
...
static HitDisable(struct stringtbl *st, struct lookzview *self, long accnum)
{
	if (self->curstyle == NULL) return;
	strtblview_ZeroOrMany(st, self, accnum);
...
static HitSpacing(struct stringtbl *st, struct lookzview *self, long accnum)
{
	enum style_SpacingValue basis;
	long points;
	if (self->curstyle == NULL) return;
...
static HitSpread(struct stringtbl *st, struct lookzview *self, long accnum)
{
	enum style_SpacingValue basis;
	long points;
	if (self->curstyle == NULL) return;
...
static HitShrink(struct labelview *shrink, enum view_MouseAction action, struct lookzview *self)
{
	struct lookz *lookz;
...
static EditStylesInWindow(struct view *textv)
{
...
static ChopTree(struct lpair *branch, struct classinfo *lpairInfo)
{
