...
struct sbutton_prefs * sbutton__GetNewPrefs(struct classheader *classID, char *name)
{
    char buf[1024];
...
void sbutton__WriteDataPart(self, fp)
struct sbutton *self;
FILE *fp;
{
    /*
...
long sbutton__ReadDataPart(self, fp, dsversion)
struct sbutton *self;
FILE *fp;
int dsversion;
{
...
int sbutton__Enumerate(struct sbutton *self, boolean (*func) (), void *rock)
{
    int i;
