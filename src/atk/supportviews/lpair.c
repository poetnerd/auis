...
boolean lpair__InitializeObject(struct classheader *classID, struct lpair *self)
{
...
struct lpair * lpair__SetUp(struct lpair *self, struct view *l1, struct view *l2, int bsize, int porf, int vorh, boolean moveable)
{
...
struct lpair * lpair__VSplit(struct lpair *tl, struct view *l1, struct view *l2, int pct, int moveable)
{
...
struct lpair * lpair__HSplit(struct lpair *tl, struct view *l1, struct view *l2, int pct, int moveable)
{
...
struct view * lpair__GetNth(struct lpair *l, int ai)
{
...
void lpair__SetNth(struct lpair *self, int ai, struct view *x)
{
