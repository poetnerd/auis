...
/* Changed bufferlist */
struct buffer * buffer__Enumerate(struct classheader *classID, procedure mapFunction, void *functionData)
{
...
struct view * buffer__EnumerateViews(struct buffer *self, procedure mapFunction, void *functionData)
{
...
/* sys_errlist removed — use strerror() instead */
