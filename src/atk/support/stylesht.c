...
struct menulist * stylesheet__GetMenuList(struct stylesheet *self, procedure procname, struct classinfo *infotype)
{
...
struct style * stylesheet__EnumerateStyles(struct stylesheet *self, procedure func, long data)
{
	struct style **curr;
