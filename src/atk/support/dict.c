...
void dictionary__Insert(struct classheader *classID, struct view *view, char *id, char *object)
{
...
char * dictionary__LookUp(struct classheader *classID, struct view *view, char *id)
{
...
long dictionary__CountRefs(struct classheader *classID, struct view *view)
{
    register struct dirtable *dd;
    long i = 0;
    for(dd = table; dd < last; dd++){
...
long dictionary__ListRefs(struct classheader *classID, struct view *view, char **refarray, long len)
{
    register struct dirtable *dd;
    long i = 0;
    for(dd = table; dd < last; dd++){
...
void dictionary__Delete(struct classheader *classID, struct view *view, char *id)
{
    register struct dirtable *dd;
    for(dd = table; dd < last; dd++)
