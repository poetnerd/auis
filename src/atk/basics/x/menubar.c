...
#include <scache.h>
#include <shadows.h>
static struct titem * AddItem();
static void BringUpMenu();
static void BringUpSubMenu();
static void BuildGraphicContext();
static void ClearMenu();
static int ComputeItemPosition();
static void ComputeMenuPositioning();
static void Configure();
static int CountGroups();
static struct tmenu * CreateMenu();
static void DestroyMenu();
static void DestroyPrefsForDisplay();
static void DoMenuLoop();
static void DrawMenuItems();
static struct titem * FindItem();
static struct tmenu * FindMenu();
static void FreeGCs();
static int GetItemAt();
static int HandleInMenu();
static int LocateMenu();
static void MakeGCs();
static void MakeWindows();
static int MoveDown();
static int MoveUp();
static unsigned long ReallyGetColor();
static void SelectItem();
static void SelectRegion();
static void SetBottomShadow();
static void SetGCs();
static void SetGray();
static void SetItemSelection();
static void SetPixmap();
static void SetTitleSelection();
static void SetTopShadow();
static void UnSelectRegion();
static void UpdateGeometry();
static int WaitTillReady();
