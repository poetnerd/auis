...
long fontdesc__StringSize(struct fontdesc *self, struct graphic *graphic, char *string, long *XWidth, long *YWidth)
{
    /* Override Me */
    return 0;
}
...
long fontdesc__StringBoundingBox(struct fontdesc *font, struct graphic *graphic, char *string, long *width, long *height)
{
  long w, junk;
