...
int filetype__DeleteEntry(struct classheader *classID, char *extension)
{
 ...
 */
char * filetype__Lookup(struct classheader *classID, FILE *file, char *filename, long *objectID, struct attributes **attributes)
{
