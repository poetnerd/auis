...
boolean chlist__AddItemAtIndex(struct chlist *self, long index, char *str, procedure proc, long data)
{
    char *mycopy;
...
boolean chlist__AddItemToEnd(struct chlist *self, char *str, procedure proc, long data)
{
