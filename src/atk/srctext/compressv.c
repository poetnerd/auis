...
void compressv__Print(struct compressv *self, FILE *f, char *process, char *final, boolean toplevel)
{
...
enum view_DSattributes compressv__DesiredSize(struct compressv *self, long width, long height, enum view_DSpass pass, long *desiredwidth, long *desiredheight)
{
...
void compressv__LinkTree(struct compressv *self, struct view *parent)
{
    struct compress *fn=(struct compress *)compressv_GetDataObject(self);
