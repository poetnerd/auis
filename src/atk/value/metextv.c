...
void metextview_CancelCommand(struct metextview *self)
{
...
void metextview_ReturnCommand(struct metextview *self)
{
    long np;
    char resp[64];
    struct mentertext *txt = Text(self);
...
void metextview_ClearCommand(struct metextview *self)
{
    struct mentertext *txt = Text(self);
...
void metextview__ReceiveInputFocus(struct metextview *self)
{
...
void metextview__LoseInputFocus(struct metextview *self)
{
    if(self->valueview)
...
boolean metextview__InitializeClass(struct classheader *classID, struct metextview *self)
{
...
void metextview__ObservedChanged(struct metextview *self, struct observable *changed, long value)
{
