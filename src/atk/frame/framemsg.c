...
/* Hairy function... */
int framemessage__AskForStringCompleted(struct framemessage *self, int priority, char *prompt, char *defaultString, char *buffer, int bufferSize, struct keystate *keystate, procedure completionProc, procedure helpProc, long completionData, int flags)
{
